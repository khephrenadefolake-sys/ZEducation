...
export default function ExercicesScreen({
  ...
  const exercice = EXERCICES[questionActuelle];
  ...
  const choisirReponse = (index) => {
    ...
    if (index === exercice.reponse) {
      setScore((ancienScore) => ancienScore + 1);
    }
  };

  const exerciceSuivant = () => {
    if (questionActuelle < EXERCICES.length - 1) {
      setQuestionActuelle(
            ...
            {pourcentage >= 80 ? (
              <>
                ...
                <Text style={styles.resultBoxText}>
                  Tu maîtrises très bien ces notions.
                  Continue ainsi !
                </Text>
              </>
            ) : pourcentage >= 50 ? (
              <>
                ...
                <Text style={styles.resultBoxText}>
                  Tu progresses bien. Relis les notions
                  que tu maîtrises moins.
                </Text>
              </>
            ) : (
              <>
                ...
                <Text style={styles.resultBoxText}>
                  Relis les leçons puis recommence les
        ...
        {correctionVisible && (
          <View style={styles.correctionBox}>
            <Text style={styles.correctionTitle}>
              {reponseSelectionnee === exercice.reponse
                ? "✅ Bonne réponse !"
                : "❌ Mauvaise réponse"}
            </Text>
